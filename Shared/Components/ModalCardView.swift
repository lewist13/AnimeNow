...
struct ModalCardView<Content: View, ShapeType: ShapeStyle>: View {
    let onDismiss: (() -> Void)?
...
struct ModalCardStyle<S: ShapeStyle> {
...
enum ModalCardOptions: CaseIterable {
    case disableDrag
...
extension View {
    func slideOverCard<Content: View, ShapeType: ShapeStyle>(
        onDismiss: (() -> Void)? = nil,
        options: Set<ModalCardOptions> = [],
        style: ModalCardStyle<ShapeType> = .init(),
